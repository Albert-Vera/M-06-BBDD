...
public class Mas extends Persona {
    ...
    static void escriureDades(Mas empleado) throws IOException {

        ObjectOutputStream objectOutputStream =
                new ObjectOutputStream(new FileOutputStream("object.data"));

        List<Mas> empleadoList = new ArrayList<>();
        empleado = new Mas();
        empleado.getNom();
        ...
        objectOutputStream.writeObject(empleadoList);
    ...
    static void mostraDades() throws IOException, ClassNotFoundException {
       ...
       //Treballador empleado = (Treballador) objectInputStream.readObject();
        List<Mas> personasList = (List<Mas>)objectInputStream.readObject();

        for (Mas listado :personasList){
